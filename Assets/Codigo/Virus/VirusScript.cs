...
public class VirusScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        life = GameObject.Find(this.gameObject.name).GetComponent<LifeVirus>();
        lifee = GameObject.Find("Linfosito").GetComponent<LifeLin>();
    }
    ...
    private void OnTriggerEnter(Collider cl)
    {
        if (val == true)
        {
            ...
            else if (cl.tag == "HitRecibedLin")
            {
                life.life = life.life - lifee.forceLin;
            }
        }
    }
